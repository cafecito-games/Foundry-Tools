...
static func create_message() -> UInt64Value:
...
func type_name() -> String:
	return UInt64Value.protobuf_type_name()

static func _pb_any_uses_value() -> bool:
	return true

## Decodes protobuf wire data into a new UInt64Value message.
static func from_bytes(_pb_data: PackedByteArray) -> (UInt64Value?, ProtobufError):
	...
	if _pb_error != ProtobufError.OK:
		var _pb_failed: UInt64Value? = null
